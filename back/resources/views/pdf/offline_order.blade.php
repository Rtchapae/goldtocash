...
<div class="WordSection1">
    ...
    <p class="MsoNormal print-field-line">
        ...
        <span class="print-underline print-underline-name print-value">{{ $user->name ?? '&nbsp;' }}</span>
        <span class="print-label">Date of Birth: </span>
        <span class="print-underline print-underline-dob print-value">{!! $dateOfBirth !== '' ? e($dateOfBirth) : '&nbsp;' !!}</span>
    </p>

    <!-- Address + City + State + ZIP -->
    <p class="MsoNormal print-field-line">
        <span class="print-label">Address: </span>
        <span class="print-underline print-underline-address print-value">{{ $user->address ?? '&nbsp;' }}</span>
        <span class="print-label">City: </span>
        <span class="print-underline print-underline-city print-value">{{ $user->city ?? '&nbsp;' }}</span>
        <span class="print-label">State: </span>
        <span class="print-underline print-underline-state print-value">{{ $user->state ?? '&nbsp;' }}</span>
        <span class="print-label">ZIP: </span>
        <span class="print-underline print-underline-zip print-value">{{ $user->zip ?? '&nbsp;' }}</span>
    </p>

    <!-- Phone + Gov. ID # + State Issued -->
    <p class="MsoNormal print-field-line-phone">
        <span class="print-label">Phone:</span>
        <span class="print-underline print-underline-phone print-value">{{ $user->phone ?? '&nbsp;' }}</span>
        <span class="print-label">Gov. ID #: </span>
        <span class="print-underline print-underline-govid print-value">{{ $govIdNumber ?: '&nbsp;' }}</span>
        <span class="print-label">State Issued: </span>
        <span class="print-underline print-underline-state-issued print-value">{{ $stateIssued ?: '&nbsp;' }}</span>
    </p>

    <!-- Transaction Details -->
    <h1 class="print-transaction-title">
        <span>Transaction Details</span>
        <span class="print-transaction-no">#: <span class="print-underline-inline print-value">{{ $order->id ?? '&nbsp;' }}</span></span>
    </h1>
    ...
    <p class="MsoNormal print-field-line-time">
        ...
        <span class="print-underline print-underline-time print-value">{{ $order->created_at ? $order->created_at->format('H:i') : '&nbsp;' }}</span>
        <span class="print-label">Date:</span>
        <span class="print-underline print-underline-date print-value">{{ $order->created_at ? $order->created_at->format('m/d/Y') : '&nbsp;' }}</span>
        <span class="print-label">Location:</span>
        <span class="print-underline print-underline-location print-value">{{ $order->branch ? $order->branch->display_name : '&nbsp;' }}</span>
    </p>
        ...
        <tbody>
            ...
            <tr>
                <td class="print-item-left">
                    <table class="print-item-row">
                        <tr>
                            <td class="print-item-num">{{ $row * 2 + 1 }}.</td>
                            <td class="print-item-line print-value">{{ $items[$row * 2] ?? '' }}</td>
                        </tr>
                    </table>
                </td>
                <td class="print-item-right">
                    <table class="print-item-row">
                        <tr>
                            <td class="print-item-num">{{ $row * 2 + 2 }}.</td>
                            <td class="print-item-line print-value">{{ $items[$row * 2 + 1] ?? '' }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <p class="MsoNormal print-field-line">
        ...
        <span class="print-underline print-underline-value print-value">{{ $order->amount ? number_format($order->amount, 2) : '&nbsp;' }}</span>
        <span class="print-label">Payment Method: </span>
        <span class="print-underline print-underline-payment print-value">{{ $order->payment_method ? ucfirst($order->payment_method) : '&nbsp;' }}</span>
    </p>
    ...
    <div class="no-page-break">
        ...
        <p class="MsoNormal print-field-line">
            ...
            <span class="print-label">Date: </span>
            <span class="print-underline print-underline-seller-date print-value">{{ $order->created_at ? $order->created_at->format('F j, Y') : '&nbsp;' }}</span>
        </p>
    </div>
</div>
@endsection
