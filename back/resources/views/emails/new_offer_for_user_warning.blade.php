                ...
                <tbody>
                    ...
                    <tr style="background: #f9f9f9;">
                        <td style="text-align: justify;padding: 20px 30px;">
                            ...
                            <p>We sent you an offer two days ago and still haven't heard from you. Please login into your account to accept our offer. Please note, your offer will auto-accept in 24 hours if we don't hear from you.*</p>
                            <p>If for any reason you are not satisfied with our offer please call our toll-free number <a href="tel:{{ $site_phone }}" target="_blank">{{ $site_phone }}</a> or email us at <a href="mailto:{{ $site_email }}" target="_blank">{{ $site_email }}</a></p>
                        </td>
                    </tr>
                    <tr style="background: #f9f9f9;">
                        <td style="text-align: justify;padding: 20px 30px;">
