<template>
	<section class="section-blog">
		<div class="container page-content">
			<div class="row justify-content-center">
				<div class="col-12">
					<div class="column text-center blog-head">
						...
						<div>
							<a class="btn btn-light" href="/gold-info">
								<img width="20" src="/images/grid-small.svg" alt="Grid small">
							</a>
							<a class="btn btn-light" href="/gold-info?small=yes">
			...
			<BlogPagination :current-page="currentPage" :total-pages="totalPages" base-path="/gold-info" />
		</div>
	</section>
</template>
...
const loadPosts = async () => {
	...
	try {
		const response = await fetchPosts({
			path_prefix: null, // null for gold-info
