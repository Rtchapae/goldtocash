<template>
	<section class="section-blog">
		<div class="container page-content">
			<div class="row justify-content-center">
				<div class="col-12">
					<div class="column text-center blog-head">
						<h1 class="font-heavy">Sell</h1>
						<h2 class="font-bold font-primary">Selling Gold & Jewelry – Guides and Tips</h2>

						<div>
							<a class="btn btn-light" href="/sell">
								<img width="20" src="/images/grid-small.svg" alt="Grid small">
							</a>
							<a class="btn btn-light" href="/sell?small=yes">
			...
			<BlogPagination :current-page="currentPage" :total-pages="totalPages" base-path="/sell" />
		</div>
	</section>
</template>
