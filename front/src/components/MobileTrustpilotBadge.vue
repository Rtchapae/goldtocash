<template>
	<div class="d-flex d-md-none justify-content-center text-center mt-5 mb-3">
		<div class="">
			<div class="base-card-hero">
				<div class="base-card__rate trustpilot-rate">
					Excellent
				</div>
				<div class="base-card__img text-center">
					<a href="https://www.trustpilot.com/review/goldtocash.us" target="_blank">
						<svg width="140px" height="43px" viewBox="0 0 512 96" version="1.1"
							xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<g fill-rule="nonzero">
									<rect id="Rectangle-path" fill="#219653" x="0" y="0" width="96" height="96"></rect>
									<rect id="Rectangle-path" fill="#219653" x="104" y="0" width="96" height="96"></rect>
									<rect id="Rectangle-path" fill="#219653" x="208" y="0" width="96" height="96"></rect>
									<rect id="Rectangle-path" fill="#219653" x="312" y="0" width="96" height="96"></rect>
									<rect id="Rectangle-path" fill="#219653" x="416" y="0" width="96" height="96"></rect>
									<path
